...
| `initiative-index.yaml` | Master-Index — jede Initiative gemappt auf Brief, Plan, Faktoren, Inventar, Reporting-Datenpunkte, Tickets |
...
| `analytics/` + `data-catalog.yaml` | `carbon-data/` + `emission-factors-catalog.yaml` |
| `engineering/plans/` + `bug-investigations/` | `implementation/plans/` + `data-quality-findings/` |
| `feature-index.yaml` | `initiative-index.yaml` |
